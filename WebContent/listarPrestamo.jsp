							...
							<form action="ServletPrestamo?tipo=registrar" id="frmregistro"
								...
								<div class="mb-3">
									<label for="nombre" class="form-label">Id Cliente:</label> <input
										...
										id="cliente" placeholder="Id Cliente" autofocus />
								</div>
								<div class="mb-3">
									<label for="nombre" class="form-label">Fecha Salida:</label> <input
										type="date" class="form-control" name="txt_salida"
										id="fechasalida" placeholder="Fecha Salida" autofocus />
								</div>
								<div class="mb-3">
									<label for="nombre" class="form-label">Fecha
										Devolución:</label> <input type="date" class="form-control"
										name="txt_devolucion" id="fechadev"
										placeholder="Fecha Devolución" autofocus />
								</div>
								<div class="mb-3">
