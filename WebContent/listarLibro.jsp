			...
			<div id="content">
				...
				<div class="container my-3">
					<div class="row">
							...
							<form action="ServletLibro?tipo=registrar" id="frmregistro"
								...
								<div class="mb-3">
									<label for="nombre" class="form-label">Editorial:</label> <input
										...
										id="editorial" placeholder="Editorial" autofocus />
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									<tr>
										<td>Género:</td>
										<td><select name="txt_genero" style="width: 150px">
												<option value="1">Didáctico</option>
												<option value="2">Dramático</option>
												<option value="3">Lírico</option>
												<option value="4">Narrativo</option>
										</select></td>
									</tr>
								</div>
								<div class="mb-3">
									<label for="nombre" class="form-label">Número de
										Páginas:</label> <input type="text" class="form-control"
										name="txt_paginas" id="paginas"
								...
								<div class="mb-3">
									...
									<div class="mb-3">
									<label for="nombre" class="form-label">Estado:</label> <input
										type="text" class="form-control" name="txt_estado" id="estado"
						...
						<div class="col-sm-12 col-md-8 col-lg-2 col-xl-8 py-4 bg-white">
							...
							<table class="table">
								...
								<thead class="thead-light">
									<tr>
										...
										<td class="centrado"><%=l.getNombreAutor()%></td>
										<td class="centrado"><%=l.getNombreGenero()%></td>
										<td class="centrado"><%=l.getNumPaginas()%></td>
										<td class="centrado"><%=l.getPrecio()%></td>
										<td class="centrado"><%=l.getEstado()%></td>
										<td class="centrado"><a
											href="ServletLibro?tipo=buscar&cod=<%=l.getIdLibro()%>">
